...
export default function SignalPage({type}:{type:"news"|"tiktok"}){
  ...
  return <div className="px-5 pb-10 pt-5 md:px-8 lg:px-10 lg:pt-6"><PageHeader eyebrow={news?"Corroboration layer":"Early signal layer"} title={news?"News intelligence":"TikTok public signals"} description={news?"Live RSS reporting and clearly labelled demo evidence, cleaned and classified through the same incident pipeline.":"Public post metadata is retained as early evidence only. No video is downloaded or embedded."}/>
